...
function InfoCard({img,location,title,description,star,price,total}) {
    return (
        <div className='flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg pr-4 transition duration-200 ease-out'>
            ...
            <div className='pl-5 flex flex-col flex-grow'>
                ...
                <div className='border-b w-10 mt-3' />
